...
// dcsScaleFactor is the scale factor at the central meridian (k_0) used by all DCS terrains.
// This is the standard UTM scale factor.
const dcsScaleFactor = 0.9996

// metersPerDegreeLatitude is an approximation for converting false northing to latitude.
// This is the average distance in meters per degree of latitude.
...
func (t Terrain) Projection() *spatial.Projection {
	return spatial.NewTransverseMercator(t.CentralMeridian, dcsScaleFactor, t.FalseEasting, t.FalseNorthing)
}

// All contains all known DCS terrains with their Transverse Mercator projection parameters.
// Parameters are sourced from pydcs (https://github.com/pydcs/dcs).
var All = []Terrain{
	...
	// TODO: Sinai, Kola, Afghanistan, Iraq parameters not yet available in pydcs
	{Name: Sinai, CentralMeridian: 33, FalseEasting: 0, FalseNorthing: 0},
	{Name: Kola, CentralMeridian: 33, FalseEasting: 0, FalseNorthing: 0},
	{Name: Afghanistan, CentralMeridian: 66, FalseEasting: 0, FalseNorthing: 0},
	{Name: Iraq, CentralMeridian: 45, FalseEasting: 0, FalseNorthing: 0},
}
