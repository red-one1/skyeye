...
//
// When working with DCS World coordinates, use WithTransverseMercatorProjection
// or WithProjection to match DCS's internal coordinate system and improve
...
func projectedDistance(p *Projection, a, b orb.Point) unit.Length {
...
// after projecting them to a Transverse Mercator coordinate system.
func projectedBearing(p *Projection, a, b orb.Point) bearings.Bearing {
	projA := p.ToProjected(a)
	projB := p.ToProjected(b)
...
// projection.
func projectedPointAtBearingAndDistance(p *Projection, origin orb.Point, bearing bearings.Bearing, distance unit.Length) orb.Point {
